...
**Per iscriversi all&#39;esame di certificazione, eseguire la procedura seguente:**

* **Passaggio 1:** Accesso riuscito a [Adobe Credential Management System](https://www.certmetrics.com/adobe){target="_blank"}.
* **Passaggio 2:** Torna su questo sito e fai clic su Certificazioni tecniche.
* **Passaggio 3:** Scegli l&#39;applicazione di Adobe, il livello di certificazione e il ruolo
* **Passaggio 4:** Segui i passaggi forniti nella sezione **Ottieni certificazione**.

**Risorse**

Esempio:

* [Come registrarsi a un esame in corso online](https://express.adobe.com/page/Opvo0RlRrlVvr/){target="_blank"}
* [Come avviare l&#39;esame e connettersi al proctor](https://express.adobe.com/page/6tQ2pnEDumKY7/){target="_blank"}
* [Requisiti di sistema per il test Examity](https://www.examity.com/test-taker-systems-requirements/){target="_blank"}

>[!TAB Esame completato]

**Adobe ID**

Il nome del [profilo](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"} nell&#39;Adobe Credential Management System deve corrispondere esattamente al tuo Government ID. La mancata corrispondenza o l&#39;assenza di informazioni identiche comporterà la chiusura dell&#39;esame da parte del proctor e richiederà di riprogrammare l&#39;appuntamento oltre al pagamento di una tassa di esame aggiuntiva.
...
Una volta completato un esame, si riceve un pass provvisorio o si fallisce. Il punteggio finale può richiedere fino a 72 ore per essere popolato. Troverai il tuo report di risultati e punteggi nella scheda Cronologia di [Adobe Credential Manager](https://www.certmetrics.com/adobe){target="_blank"}.
...
**Prezzi per esami di certificazione**
...
La maggior parte dei rinnovi della certificazione sono **gratuiti**. Per le certificazioni che non dispongono di un&#39;opzione di rinnovo gratuito, è necessario ripetere l&#39;esame di certificazione completo per rinnovare la certificazione.
...
I partner Bronze e superiori ottengono sconti su tutti gli esami e le classi di certificazione Adobi. Per ulteriori informazioni su questo sconto e su come accedere ai vantaggi per i partner, consulta il [portale per i partner delle soluzioni](https://solutionpartners.adobe.com/solution-partners/home/learn/credentials/certification/certification_exam_registration_and_management.html?nav=cost){target="_blank"}.
...
* [Prima occorrenza test](https://vimeo.com/394506654){target="_blank"}
* [Come pianificare l&#39;appuntamento di prova](https://vimeo.com/394506786){target="_blank"}
...
Le sezioni e i collegamenti seguenti funzioneranno solo dopo aver eseguito correttamente l&#39;accesso a [Adobe Credential Management System](https://www.certmetrics.com/adobe){target="_blank"}.

| Collegamenti rapidi | Descrizione |
| ------- | ------- | 
| Adobe sistema di gestione delle credenziali | [Accesso iniziale a Gestione credenziali Adobe](https://www.certmetrics.com/adobe){target="_blank"} |
| Profilo | [Pagina di informazioni demografiche con nome dell&#39;account, indirizzo, società e così via. I nomi possono essere aggiornati solo da un Adobe Admin](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"}. |
| Identificazione | [Posizione dell&#39;Adobe/ID di accesso. In genere inizia con ADB](https://www.certmetrics.com/adobe/candidate/identification.aspx){target="_blank"} |
| Cronologia | [Visualizza il report punteggio e la cronologia esami](https://www.certmetrics.com/adobe/candidate/cert_summary.aspx){target="_blank"} |
...
* **Passaggio 1:** Accedi a [In modo credibile](https://www.credly.com/users/sign_in){target="_blank"}. _(Devi usare la stessa e-mail che hai usato per guadagnare le tue credenziali di Adobe, altrimenti non vedrai il tuo distintivo.)_
...
* **Passaggio 2:** Crea un account. _(Devi usare la stessa e-mail che hai usato per guadagnare le tue credenziali di Adobe, altrimenti non vedrai il tuo distintivo.)_
* **Passaggio 3:** Accetta e condividi il tuo distintivo.
