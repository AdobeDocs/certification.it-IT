...
>[!NOTE]
>
>**Nuove risorse di studio disponibili:** La [Guida alla preparazione degli esami](https://app.rockinfo.com/courses/252) fornisce un percorso personalizzato attraverso il processo di preparazione degli esami di certificazione, inclusi i materiali di studio approfonditi necessari per ottenere questa certificazione. _Se viene richiesto di accedere alla Guida alla preparazione esami, utilizzare il proprio Adobe ID._
...
* sviluppatore Adobe [!DNL Campaign Classic]
...
**Sezione 1: configurazione di sistema (16%)**
...
* Applicare le librerie JavaScript a flussi di lavoro, chiamate SOAP, regole di tipologia e blocchi di personalizzazione
* Descrivere le procedure consigliate per l&#39;utilizzo delle funzioni SQL nell&#39;Adobe [!DNL Campaign Classic]
* Considerato uno scenario, comprendere come utilizzare gli script SQL nell&#39;Adobe [!DNL Campaign Classic]
...
**Sezione 5: manutenzione istanza (12%)**
...
* Identifica l’utilizzo di JavaScript appropriato nel flusso di lavoro di Campaign e perché
...
[rispondere al questionario di preparazione in linea](https://scorpion.caveon.com/launchpad/ad-q-e129-readiness-questionnaire-for-adobe-aem-assets-developer-professional-exam-copy-21ocv4/ad-q-e312-readiness-questionnaire-adobe-campaign-classic-developer-expert-exam){target="_blank"}
...
[Visualizza guida preparazione esami](https://app.rockinfo.com/courses/252)
