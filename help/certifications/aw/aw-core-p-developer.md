...
>[!NOTE]
>
>Questo esame, Adobe [!DNL Workfront] Core Developer Professional (AD0-E905), è stato aggiornato. Se hai già iniziato a studiare o hai in programma di utilizzare questa versione, assicurati di completarla prima del 26 febbraio 2024. Se hai appena iniziato, ti consigliamo di prendere [versione più recente di questo esame (AD0-E908)](aw-core-p-developer-23-12.md). Se devi riprogrammare, devi sostenere il nuovo esame.
...
* Approfondimento degli Adobi [!DNL Workfront] tipi di oggetto, inclusi moduli personalizzati e flussi di lavoro di approvazione, modelli, durate, lavoro/ore pianificate
* Approfondimento degli Adobi [!DNL Workfront] Configurazione, inclusi livelli di accesso, modelli di layout, preferenze di progetto e altri metodi per ottenere semplicità di progettazione per l’utente finale
...
* Familiarità con Adobe [!DNL Workfront]
...
[rispondere al questionario di preparazione online](https://scorpion.caveon.com/launchpad/ad-q-e905-readiness-questionnaire-for-adobe-workfront-core-developer-professional/ad-q-e905-readiness-questionnaire-for-adobe-workfront-core-developer-professional){target="_blank"}
...
* [Panoramica del Portfolio nell’Adobe [!DNL Workfront]](https://experienceleague.adobe.com/docs/workfront/using/manage-work/portfolio-management/portfolio-overview-in-adobe-workfront/portfolio-overview.html){target="_blank"}
...
* [Inviare e condividere i rapporti](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/how-to-send-and-share-reports.html){target="_blank"}
* [Best practice - Rapporti personalizzati](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/best-practices/custom-reports-bp.html){target="_blank"}
...
>[!NOTE]
>
>Questo esame, Adobe [!DNL Workfront] Core Developer Professional (AD0-E905), è stato aggiornato. Se hai già iniziato a studiare o hai in programma di utilizzare questa versione, assicurati di completarla prima del 26 febbraio 2024. Se hai appena iniziato, ti consigliamo di prendere [versione più recente di questo esame (AD0-E908)](aw-core-p-developer-23-12.md).
